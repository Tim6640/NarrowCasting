...
<div class="col-md-3">
    <div class="list-group">
        ...
        <a href="components.php" class="list-group-item <?php echo $components ?>"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Components <span class="badge"><?php echo count($component->getComponents())?></span></a>
