...
<div class="col-md-3">
    <div class="list-group">
        <a href="dashboard.php" class="list-group-item <?php echo $dashboard ?>"><span class="glyphicon glyphicon-tasks" aria-hidden="true"></span> Dashboard</a>
        ...
        <a href="components.php" class="list-group-item <?php echo $components ?>"><span class="glyphicon glyphicon-link" aria-hidden="true"></span> Components <span class="badge"><?php echo count($component->getComponents())?></span></a>
