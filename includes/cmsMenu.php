...
<div class="col-md-3">
    <div class="list-group">
        ...
        <a href="users.php" class="list-group-item <?php echo $users ?>"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Beheerders <span class="badge"><?php echo count($user->getUsers())?></span></a>
